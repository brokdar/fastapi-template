...
class APIKeyService:
    ...
    def __init__(
        ...
        self._hasher: APIKeyHasher = hasher
        self._max_per_user: int = max_per_user
        self._default_expiration_days: int = default_expiration_days
    ...
    async def delete_key(self, key_id: APIKeyID, user_id: UserID) -> None:
    ...
    async def delete_key_admin(self, key_id: APIKeyID, admin_id: UserID) -> None:
    ...
    async def list_keys(self, user_id: UserID) -> list[APIKey]:
    ...
    async def validate_key(self, key: str) -> tuple[UserID, APIKeyID]:
    ...
    async def _update_last_used_safely(self, key_id: APIKeyID) -> None:
