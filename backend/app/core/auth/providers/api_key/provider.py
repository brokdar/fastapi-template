...
class APIKeyProvider(AuthProvider):
    ...
    async def authenticate(
        ...
        Returns None on failure to allow fallback to other providers.
        """
    ...
    def get_security_scheme(self) -> SecurityBase:
        ...
        Returns:
            SecurityBase: APIKeyHeader security scheme for OpenAPI docs.
        """
    ...
    def get_router(self) -> APIRouter:
        ...
        Returns:
            APIRouter: Router with API key management endpoints.
        """
